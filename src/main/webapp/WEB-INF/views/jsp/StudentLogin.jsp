...
<%@ taglib uri="http://www.springframework.org/tags/form" prefix="f" %>
            ...
            <div class="col-lg-5">
                    <form action="${pageContext.request.contextPath }/Student-login-submit" method="post" class="form-horizontal">
                      <!-- Title -->
                      ...
                      <!-- Content -->
                      <div class="form-group">
                        <label class="control-label col-lg-2" for="content">D.O.B</label>
                        <div class="col-sm-7">
                          <input type="password" name="pass" placeholder="yyyy-mm-dd" class="form-control" id="content"/>
                        </div>
                       </div>
